...
public class LogContentProvider extends ContentProvider {
    ...
    protected static Uri eventsUri(Context context)
    ...
    public boolean onCreate() {
        ...
        SQLiteOpenHelper helper = new SQLiteOpenHelper(context, "event_log.db",
                null, LogContentProvider.DATABASE_VERSION) {
            public void onCreate(SQLiteDatabase db) {
                db.execSQL(context
                        .getString(R.string.db_create_events_log_table));
            ...
            public void onUpgrade(SQLiteDatabase db, int oldVersion,
                ...
                case 1:
                    db.execSQL(context
                            .getString(R.string.db_create_uploads_log_table));
                default:
                    break;
                }
            }
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        case LogContentProvider.APP_UPLOADS:
            return this._db.delete(LogContentProvider.APP_UPLOADS_TABLE,
                    selection, selectionArgs);
        }
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        ...
        switch (this._matcher.match(uri)) {
        case LogContentProvider.APP_EVENTS:
            id = this._db.insert(LogContentProvider.APP_EVENTS_TABLE, null,
                    values);
            break;
        case LogContentProvider.APP_UPLOADS:
            id = this._db.insert(LogContentProvider.APP_UPLOADS_TABLE, null,
                    values);
            break;
        }
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        case LogContentProvider.APP_EVENTS:
            return this._db
                    .query(LogContentProvider.APP_EVENTS_TABLE, projection,
                            selection, selectionArgs, null, null, sortOrder);
        case LogContentProvider.APP_UPLOADS:
            return this._db
                    .query(LogContentProvider.APP_UPLOADS_TABLE, projection,
                            selection, selectionArgs, null, null, sortOrder);
        }
    ...
    public int update(@NonNull Uri uri, ContentValues values, String selection,
        ...
        case LogContentProvider.APP_EVENTS:
            return this._db.update(LogContentProvider.APP_EVENTS_TABLE, values,
                    selection, selectionArgs);
        case LogContentProvider.APP_UPLOADS:
            return this._db.update(LogContentProvider.APP_UPLOADS_TABLE,
